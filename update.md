...
| 날짜 | 주요 내용 |
|------|-----------|
| [2026-07-07](changelog/2026-07-07.md) | 시즌2 유튜브 에디션 코드 준비 — YouTube 롱폼 전용 인증(쇼츠 거부), 메달→스트릭 교체, 시작일 07-13, 주간 정산 달성/미달성 포맷, 참가자 2인, bugs 001·002 closed |
| [2026-04-14](changelog/2026-04-14.md) | URL 단축 Supabase DB 자체 구현 전환, r 리다이렉트 함수 신규, 비공개 메달 누락 버그 수정, 로컬 개발 환경 구성 |
| [2026-04-06](changelog/2026-04-06.md) | Instagram/Threads OG 파싱 429 버그 수정, 해당 플랫폼 요약 고정값 처리, 유닛 테스트 보완 |
| [2026-04-04](changelog/2026-04-04.md) | Edge Function 레이어드 구조 리팩토링, _shared/ 모듈 확충, URL 단축 기능, OG 파싱 정확도 개선 |
| [2026-03-26](changelog/2026-03-26.md) | 주간 정산 Discord 멘션 추가, 대시보드 링크 추가 |
